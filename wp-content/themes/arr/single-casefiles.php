			...
			<div class="sidebar">
				<div class="photo-container">
					...
					if ($photos) { ?>
						...
						<div class="photo-button-container"><a href="#" class="button" id="js-photo-button">See More Photos</a></div>
						...
						<?php query_posts(array('post_type' => 'Case Updates', 'order' => 'ASC', 'posts_per_page' => 100, 'post_parent' => $post->ID)); ?>
							<?php if(  have_posts() ) { ?>
								<?php while ( have_posts() ) : the_post(); ?>
									<div class="reports case-update">
										<h3><?php echo get_the_date(); ?></h3>
										<a class="cont" href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
									</div>
			...
			<div class="cont-left">
				...
				<?php $the_query = new WP_Query( 'page_id=6' ); if( $the_query->have_posts() ) : while( $the_query->have_posts() ) : $the_query->the_post(); ?>
					<div class="info cont">
						...
						<?php the_field('your_resources', 6); ?>
